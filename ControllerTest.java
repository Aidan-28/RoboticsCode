...
@TeleOp(name = "Controller Test") // USE TESTING2023 CONFIGURATION
public class ControllerTest extends LinearOpMode {
    ...
    public void initialize() {
        ...
        launchMotor = null;//hardwareMap.get(DcMotor.class, "launchMotor");
    ...
    public void strafeFunnyLeft() {
        powerDrive2(4,-4,1.5,-1.5);
        sleep(100);
    }
    public void strafeFunnyRight() {
        powerDrive2(-4,4,-1.5,1.5);
        sleep(100);
    }
